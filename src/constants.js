...
export const contactLinks = [{ name: 'Stack Overflow', url: 'https://img.icons8.com/external-tal-revivo-color-tal-revivo/40/000000/external-stack-overflow-is-a-question-and-answer-site-for-professional-logo-color-tal-revivo.png', link: 'https://stackoverflow.com/users/30864131/rajat' },
{ name: 'Instagram', url: 'https://img.icons8.com/doodle/40/000000/instagram-new--v2.png', link: 'https://www.instagram.com/rajat__invincible?igsh=MWF1bjhkeTQ3dndxcw==' },
{ name: 'Github', url: 'https://img.icons8.com/doodle/40/000000/github--v1.png', link :'https://github.com/Rajat00612'},
{ name: 'LinkedIn', url: 'https://img.icons8.com/doodle/40/000000/linkedin--v2.png',target:"_blank", link: 'https://www.linkedin.com/in/rajat-b115a5355/'}
]
...
export const serviceData = [
  {
    ...
    desc: 'Full stack development encompasses many different skills and disciplines in the creation and maintenance of web applications. The different areas of full stack development include front-end development, back-end development, database management, API integration, including RESTful and GraphQL services, server and deployment management, and application performance optimization',
